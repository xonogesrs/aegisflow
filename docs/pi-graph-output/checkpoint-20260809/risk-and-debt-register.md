...
| R-11 | P1 | Legacy commit/push/PR gates read `external-review-result.json`, not Current `delivery.json` | `src/governance/integration-commit-gate.mjs:11-18`; `scripts/gov-commit-integration.mjs:69-82` | One Current/Archive verdict authority |
| R-12 | P1 | State-driven closeout accepts graph evidence with weak schema/digest/provenance binding and can derive internal PASS from supplied result | `src/governance/closeout-state.mjs:189-232`; `src/governance/review-bundle.mjs:2703-2708,3031-3036` | Require runner-owned, digest-bound evidence |

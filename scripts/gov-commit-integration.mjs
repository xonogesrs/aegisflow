 ...
 * or the canonical default (~/Desktop/AutoLoop-Review/Current).
 */
...
function attestationMain(flags, cwd) {
  ...
  if (!surface) {
    fail("HOLD / DELIVERY_MISSING", "commit integration requires the canonical external-review delivery surface (--surface, default ~/Desktop/AutoLoop-Review/Current)");
  }
